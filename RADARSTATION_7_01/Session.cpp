...
void Session::createStack() 
{
	...
	cout << "\n	Number of Tiny-Superlopez-from Surprise: " << numberSTS << endl;
	cout << "	Time for creation and insertion: " << timeAverage << endl;
	cout << "	Time for whole operation: " << timeOp << endl << endl;
}
...
int Session::getTimeOp() 
{
	return timeOp;
}
int Session::getTimeAverage() 
{
	return timeAverage;
}
...
void Session::setTimeAverage(int timeGiven)
{
	timeAverage = timeGiven;
}
void Session::setTimeOp(int timeGiven)
{
	timeOp = timeGiven;
}
